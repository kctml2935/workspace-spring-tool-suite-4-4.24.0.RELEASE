...
public class OrderSQL {
	...
	public final static String ORDERITEM_INSERT ="insert into order_item(oi_no,oi_qty,order_no,l_no) values(order_item_oi_no_SEQ.nextval,1,orders_order_no_SEQ.currval,?)";
