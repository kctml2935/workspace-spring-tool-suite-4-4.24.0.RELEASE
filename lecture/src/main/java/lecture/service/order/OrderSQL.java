...
public class OrderSQL {
	...
	public final static String ORDER_SELECT_BY_ORDER_NO="select * from orders where order_no=?";
	...
	public final static String ORDER_SELECT_WITH_ORDERITEM_BY_USER_ID="select * from orders o join order_item oi on o.order_no=oi.order_no join lecture l on oi.l_no=l.l_no where o.user_id=?";
