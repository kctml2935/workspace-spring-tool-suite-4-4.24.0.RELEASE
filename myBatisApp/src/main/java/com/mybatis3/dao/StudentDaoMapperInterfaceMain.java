...
public class StudentDaoMapperInterfaceMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		+mapperInterfaceStudentDao.updateStudentById(Student.builder()        .studId(88)
																			  .name("팔이름")
		...
		*/
		...
		System.out.println("delete row count:"+mapperInterfaceStudentDao.deleteStudentById(61));
	}
